...
from command_handler import (
    ...
    thoughts_command, help_command, fitness_command
)
...
async def post_init(app: Application):
    ...
    scheduler.add_job(send_morning_digest, CronTrigger(hour=8, minute=0, timezone=pytz.timezone(TIMEZONE)), args=[app.bot], id='morning_digest')
    scheduler.add_job(send_evening_digest, CronTrigger(hour=22, minute=0, timezone=pytz.timezone(TIMEZONE)), args=[app.bot], id='evening_digest')
    scheduler.start()
